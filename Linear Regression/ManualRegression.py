...
#print(xy) to check your results before proceeding
...
plt.scatter(x_plot, y_plot, label = 'Points over the years 1996/2020')
plt.scatter(x2021, y2021, label = 'Actual Points of 2020-21')
#plt.scatter(x_plot, y_pred1) To show points. Good to verify


plt.plot(x_plot, y_pred1, color = 'red', label = 'Regression line')
plt.plot(x2021, y2021, color = 'blue', label = 'Actual result of 2020-21')
...
plt.text(8, 3.9, "Model based on using Points from years 1996-2020\n  to predict Points of teams in 2020-21", color = '#53162f', size = '11')
plt.text(8, 4.7, f'Slope: {slope}', color = 'red', size= '10')
plt.text(8, 5.5, f'Intercept: {intercept}', color = 'red', size= '10')
plt.text(8, 6.8, f'     Co-eff of determination\n(Accuracy): {r}', color = 'red', size= '10')


plt.text(80, 20, "Twitter: @aprakash_7", color = '#5CBFEB', size = '12')
plt.text(84, 19.4, "Stats via fbref", fontname= 'Franklin Gothic Medium', color = 'black', size = '13')
#'Impact' 

plt.text(96, 1.8, "Man city\n (100)", color ='red', size = '9')
plt.text(7, 19.6, "Derby County\n  08/09 (11) ", color = 'red', size= '9')
